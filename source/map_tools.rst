...
Для проекте сбора данных может быть `установлен охват <https://docs.nextgis.ru/docs_ngcom/source/collector.html#collector-create-project>`_. Тогда если точка выходит за границу проекта (чаще всего это происходит из-за сбоев определения местоположения), появится предупреждение. 
